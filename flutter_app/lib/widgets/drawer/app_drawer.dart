          ...
          children: [
            ...
            Positioned(
              ...
              child: Stack(
                children: [
                  Positioned(
                    right: isSideListOpen ? MediaQuery.of(context).size.width * 0.85 * 0.5 : 0,
                    top: 0,
                    bottom: 0,
                    width: isSideListOpen ? MediaQuery.of(context).size.width * 0.85 * 0.5 : MediaQuery.of(context).size.width * 0.85,
                    child: Container(
